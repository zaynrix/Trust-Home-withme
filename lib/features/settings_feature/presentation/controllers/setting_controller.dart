...
List<Icon> settingListIcons=[
  Icon(Icons.person_outline,color: AppColors.headLine4Color,),
  Icon(Icons.notifications_none,color: AppColors.headLine4Color,),
  Icon(Icons.privacy_tip_outlined,color: AppColors.headLine4Color,),
  Icon(Icons.language,color: AppColors.headLine4Color,),
  Icon(Icons.help_outline_outlined,color: AppColors.headLine4Color,),
  Icon(Icons.logout,color: AppColors.headLine4Color,),
];
...
return Switch(value: status,activeColor: AppColors.primaryColor, onChanged: (value) {
setState(()=>
   status=value);
 },
     ...
     builder: (context) {
       return Padding(
         ...
         child: Wrap(
           ...
           children: [
             Text(AppTexts.logout,style: context.theme.textTheme.headline1?.copyWith(
                 fontSize: 20.sp
             ),),
             Padding(
               padding:  EdgeInsets.all(10.0),
               child: Text('هل أنت متأكد من أنك تريد تسجيل الخروج ؟',style: context.theme.textTheme.headline3,),
             ),
             MaterialButton(onPressed: (){},
               child:   Text('نعم , قم بإزلته',style: context.theme.textTheme.headline2,),
             ...
             Padding(
               ...
               child:   MaterialButton(onPressed: (){},
                 child:   Text(AppTexts.cancle.tr,style: context.theme.textTheme.headline5,),
