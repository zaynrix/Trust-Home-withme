          ...
          child: Form(
            ...
            //     child:
                  ...
                  children: <Widget>[
                    Card(
                      child: ListTile(
                        title:  Text(AppTexts.buy.tr,style: context.theme.textTheme.headline3),
                        leading: Radio<States>(
                          value: States.Buy,activeColor: AppColors.primaryColor,
                          groupValue: controller.state,
                    ...
                    Card(
                      child: ListTile(
                        title:  Text(AppTexts.rent.tr,style: context.theme.textTheme.headline3),
                        leading: Radio<States>(
                          value: States.Rent,activeColor: AppColors.primaryColor,
                          groupValue: controller.state,
                          onChanged: (States? value) {
                            setState(() {
                              controller.state = value!;
