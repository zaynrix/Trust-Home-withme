    ...
    return GetBuilder<HomeController>(
      builder:(controller)=> Scaffold(
        ...
        bottomNavigationBar: BottomNavigationBar(
          ...
          items: [
                  BottomNavigationBarItem(icon: Icon(Icons.home_outlined),label:AppTexts.home.tr ),
                  BottomNavigationBarItem(icon: Icon(Icons.message_outlined),label:AppTexts.messages.tr ),
                  BottomNavigationBarItem(icon: Icon(Icons.favorite_border_outlined),label:AppTexts.favorite.tr),
                  BottomNavigationBarItem(icon: Icon(Icons.settings_outlined),label:AppTexts.settings.tr ),
