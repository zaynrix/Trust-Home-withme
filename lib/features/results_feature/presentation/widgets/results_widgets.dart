...
class ResultCard extends StatelessWidget {
  ...
  ResultCard({required this.homeEntity});
                ...
                Row(
                  ...
                  children: [
                    Text(
                      homeEntity.location +
                          " ," +
                          homeEntity.subLocation1 +
                          ", " +
                          homeEntity.subLocation2,
                    ...
                    TextButton(
                        ...
                        }, child: Text(AppTexts.detailes,style: context.theme.textTheme.headline5?.copyWith(
